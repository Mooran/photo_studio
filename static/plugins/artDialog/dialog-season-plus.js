...
$.extend(Popup.prototype, {
    ...
    show: function (anchor) {
        ...
        this.__backdrop.addClass(this.className + '-backdrop').show();
    ...
    // 置顶浮层
    __zIndex: function () {
        var index = (Popup.zIndex += 2); // edit by season.chen
    ...
    __follow: function (anchor) {
        ...
        $.each(align, function (i, val) {
            ...
            if (temp[i][val] > range[name[val]][1]) {
                if ($elem.attr('data-aui-noreverse') && (val == 'bottom')) {
                    // 此时什么都不做， 由season.chen 临时添加，为了不让对话框高度变化时上下跳
                } else {
...
artDialog.create = function (options) {
    ...
    // 添加视觉参数
    $popup.addClass(this.skin)
    // this._$('dialog').addClass(this.skin); edit by season.chen
